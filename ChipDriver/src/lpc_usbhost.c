...
//
// Modified version of NXP original file -  which now splits the board
// specific initialisation code from the generic usb host driver code.
// Initialisation code placed into 'usb_host_init.c' file.
// ===================================================================

...
#define MB_SLAVE_TCP_EN            1      //Modbus RS485 TCP从栈功能
#define MB_MASTER_RTU_EN           1      //Modbus RS485 主栈功能 
#define MB_MASTER_TCP_EN           0      //Modbus RS485 TCP主栈功能 
...
#define SYSTEM_POLL_TASK_PRIO         5
#define SYSTEM_EVENT_TASK_PRIO        5
#define SYSTEM_MONITOR_TASK_PRIO      5

#define INPUT_RECEIVE_TASK_PRIO		  6       
#define SEGMENT_TASK_PRIO  			  6

#define EEPROM_DATA_TASK_PRIO         7

#define MB_SLAVE_POLL_TASK_PRIO  	   8
#define MB_SLAVE_TCP_SERVER_TASK_PRIO  8
#define MB_MASTER_POLL_TASK_PRIO  	   8

#define MB_MASTER_SCAN_WRITE_TASK_PRIO 9
#define MB_MASTER_SCAN_READ_TASK_PRIO  9

#define WATCHDOG_FEED_TASK_PRIO  	  10
#define TASK_STACK_WATCH_TASK_PRIO    11 
...
#define LWIP_CREATE_TASK_STK_SIZE         100

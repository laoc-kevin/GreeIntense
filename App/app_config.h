...
#define OUTPUT_SET_TASK_EN                    1      //IO输出数据接收功能
#define INPUT_RECEIVE_TASK_EN                 1      //IO输入数据接收功能
...
#define TASK_STACK_WATCH_EN                   0      //内存监控功能
...
#define  	EEPROM_DATA_TASK_PRIO  			  14

#define  	SYSTEM_MONITOR_TASK_PRIO          15
#define  	SYSTEM_EVENT_TASK_PRIO            16

#define  	MB_SLAVE_POLL_TASK_PRIO  	      17
#define  	MB_MASTER_POLL_TASK_PRIO  	      18
#define  	MB_MASTER_SCAN_TASK_PRIO  	      19
...
#define  	WATCHDOG_FEED_TASK_PRIO  	      23
#define     TASK_STACK_WATCH_TASK_PRIO        24 

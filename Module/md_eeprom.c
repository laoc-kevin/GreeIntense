...
#define RUNTIME_SAVE_COUNT  6			//运行时间类型的参数记忆数量
#define RUNTIME_SAVE_SIZE   RUNTIME_SAVE_COUNT * sizeof(uint32_t)		//运行时间类型记忆字节长度

#define E32_SAVE_COUNT		1			//能耗统计uint32类型的参数记忆数量
...
#if EEPROM_RUNNING_TIME_INIT > 0   //运行时间复位   
